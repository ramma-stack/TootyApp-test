...
<body>
    ...
    <main class="w-full h-screen flex gap-5 overflow-x-hidden bg-gray-100 font-rabar">
        ...
        <section x-data="{ isActive: false }" class="w-full grid grid-cols-8 gap-10 py-16 px-8">
            ...
            {{-- Left side --}}
            <div :class="{ 'col-span-7': !isActive, 'col-span-6': isActive }"
                class="w-full col-span-7 flex flex-col gap-5">
                                    ...
                                    <table class="min-w-full">
                                        <thead class="bg-transparent">
                                            <tr>
                                                ...
                                                <th scope="col" class="px-3 py-3 text-right"></th>
                                                <th scope="col" class="px-3 py-3 text-right"></th>
                                                <th scope="col" :class="{ 'hidden': isActive }"
                                                    class="px-3 py-3 text-right"></th>
                                                <th scope="col" :class="{ 'hidden': isActive }"
                                                    class="px-3 py-3 text-right"></th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="h-px w-10">
                                                    <div x-data="{ showModal: false }"
                                                        class="px-3 py-3 flex justify-center">
                                                ...
                                                <td :class="{ 'hidden': isActive }"
                                                    class="h-px w-20 whitespace-nowrap">
                                                    <div class="px-3 py-3 flex justify-center">
                                            ...
                                            <tr>
                                                ...
                                                <td :class="{ 'hidden': isActive }"
                                                    ...
                                                    <div class="px-3 py-3 flex justify-center">
                                                        <div
                                                            class="border-2 border-gray-400 rounded-2xl p-0.5 pt-[3px]">
                                                            <span
